...
toc: yes
title: "An skeleton assessment for St Matthew Blue King crab in GMACS"
---
...
1. Stock: snow crab, *Chionoecetes opilio*.
...
plot_cpue(M, ShowEstErr = TRUE, "ADFG_Pot", ylab = "Survey biomass")
