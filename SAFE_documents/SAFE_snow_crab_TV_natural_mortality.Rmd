...
.MODELDIR = c(
              paste0(dirname(getwd()), "/GMACS_versions/GMACS_Terminal_molt/GMACS_V_1_00/build/",Spc,"/"),
              paste0(dirname(getwd()), "/GMACS_versions/GMACS_Terminal_molt/GMACS_V_1_01/build/",Spc,"/"),
              paste0(dirname(getwd()), "/GMACS_versions/Latest_Version/build/",Spc,"/")
              )
...
# if(!file.exists(paste(.MODELDIR[1],"plots/",sep=""))) dir.create(paste(.MODELDIR[1],"plots/",sep=""))
#  
