...
toc: yes
title: "An skeleton assessment for Bristol Bay Red King crab in GMACS"
---
...
.MODELDIR = c(
              ...
              paste0(getwd(), "/Dvpt_Version/build/",Spc,"/")
              )
...
.FLEET    = c("Pot_Fishery","Trawl_Bycatch","Bairdi_Fishery_Bycatch","Fixed_Gear","NMFS_Trawl", "BSFRF")
...
1. Stock: Bristol Bay red king crab.
...
```{r,echo=FALSE,warning=FALSE,message=F,fig.width=8.5,fig.height=7,fig.cap="\\label{cpue_1}Model fits to the NMFS trawl survey."}
...
```{r,echo=FALSE,warning=FALSE,message=F,fig.width=8.5,fig.height=7,fig.cap="\\label{cpue_2}Model fits to the BSFRF survey."}
...
# include_graphics("plots/size_ridges_8.png")
...
# include_graphics("plots/size_ridges_9.png")
...
# include_graphics("plots/size_ridges_12.png")
...
# include_graphics("plots/size_ridges_13.png")
