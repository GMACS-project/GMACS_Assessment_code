...
The most recent version of GMACS is a UNIFIED code and can therefore be used for all stocks (see ["GMACS V 2.01.L03"](https://github.com/GMACS-project/GMACS_Assessment_code/releases/tag/V2.01.L03) release). Other developments are currently in progress and will be uploaded as soon as possible.
